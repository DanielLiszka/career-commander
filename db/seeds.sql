...
INSERT INTO application (offer, accepted, interview1_date, interview2_date, interview3_date, interview4_date, position_id, resume_id, user_id, company_id, manager_id, created_at, updated_at)
VALUES (true,false, '2022-06-17', null, null, null, 1,1,1,1,1, NOW(), NOW()),(false,false, '2022-06-17', null, null, null, 2,3,3,2,3, NOW(), NOW()),(false,false,'2022-07-06', null, null, null, 3,4,3,3,4, NOW(), NOW()),(false,false,'2022-06-022', null, null, null, 4,5,2,4,5, NOW(), NOW()),(false,false,null, null, null, null, 5,6,4,4,6, NOW(), NOW()),(false,false, '2022-07-06', null, null, null, 6,2,1,1,2, NOW(), NOW());